...
build-print-proof-lulu-pandoc-pdf-native-headers: generate-print-pericopes
	$(PYTHON) scripts/build_print_proof_bible.py --lulu-pod-margins --run-in-verse-paragraphs --run-in-group-size 0 --include-openbible-crossrefs --max-crossref-refs 4 --output output/print/the_greek_heritage_study_bible_lulu_print_proof.docx --diagnostics output/print/the_greek_heritage_study_bible_lulu_print_proof_diagnostics.json --readme output/print/README_lulu.md
	$(PANDOC) output/print/the_greek_heritage_study_bible_lulu_print_proof.docx -s -o output/print/the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.tex --lua-filter scripts/pandoc_split_xrefs.lua --lua-filter scripts/pandoc_pericope_keep.lua --lua-filter scripts/pandoc_native_print_marks.lua -H scripts/pandoc_enable_native_print_headers.tex -H scripts/pandoc_print_header_8_75_green_xrefs.tex -V documentclass=extarticle -V papersize=letter -V classoption=twoside -V geometry:inner=0.55in -V geometry:outer=0.40in -V geometry:top=0.55in -V geometry:bottom=0.35in -V mainfont="Times New Roman" -V mainfontoptions=Ligatures=NoCommon
	cd output/print && $(XELATEX) -interaction=nonstopmode -halt-on-error -cnf-line=stack_size=500000 the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.tex
	cd output/print && $(XELATEX) -interaction=nonstopmode -halt-on-error -cnf-line=stack_size=500000 the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.tex
	cd output/print && $(XELATEX) -interaction=nonstopmode -halt-on-error -cnf-line=stack_size=500000 the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.tex
	rm -f output/print/the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.aux output/print/the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.log output/print/the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.out output/print/the_greek_heritage_study_bible_lulu_print_proof_pandoc_native_headers.tex
