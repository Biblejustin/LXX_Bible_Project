...
- Source text: `data/raw/lxx_greek/ot_full.csv` plus `data/raw/tr_greek/nt_full.csv`. OT translation work is made from the LXX Greek source rows; NT translation work is made from the Scrivener 1894 Textus Receptus Greek stream.
