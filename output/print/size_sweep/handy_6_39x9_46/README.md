...
- `the_greek_heritage_study_bible_handy_6_39x9_46.docx`: compact DOCX for inexpensive physical proofreading.
- `the_greek_heritage_study_bible_handy_6_39x9_46_diagnostics.json`: build counts and DOCX validation details.
- `the_greek_heritage_study_bible_handy_6_39x9_46.pdf`: Lulu-ready upload PDF.
- `the_greek_heritage_study_bible_handy_6_39x9_46_pdf_headers.json`: PDF page-header diagnostics.
- `the_greek_heritage_study_bible_handy_6_39x9_46_pandoc.pdf`: optional Pandoc/XeLaTeX PDF with two-column footnotes.
...
- Cross-reference refs kept: `80165`
