...
MANUAL_CONTEXTUAL_TRANSLITERATED_NOTE_ROWS = [
    {
        "name": "Irad",
        "kind": "person",
        "first_reference": "Genesis 4:18",
        "source": "ot",
        "english_equivalent": "Irad",
        "source_form": "Irad",
        "greek_form": "Γαϊδάδ",
        "name_meaning": "wild ass; heap of empire; dragon",
        "equivalent_source": "manual Cainite genealogy review",
        "equivalent_confidence": "manual",
        "footnote": "Personal-name meaning: Irad - wild ass; heap of empire; dragon. Source form: Irad. Greek form: Γαϊδάδ. Equivalent source: manual Cainite genealogy review.",
    },
    {
        "name": "Mehujael",
        "kind": "person",
        "first_reference": "Genesis 4:18",
        "source": "ot",
        "english_equivalent": "Mehujael",
        "source_form": "Mehujael",
        "greek_form": "Μαλελεήλ",
        "name_meaning": "who proclaims God",
        "equivalent_source": "manual Cainite genealogy review",
        "equivalent_confidence": "manual",
        "footnote": "Personal-name meaning: Mehujael - who proclaims God. Source form: Mehujael. Greek form: Μαλελεήλ. Equivalent source: manual Cainite genealogy review.",
    },
    {
        "name": "Methusael",
        ...
        "first_reference": "Genesis 4:18",
        "source": "ot",
        "english_equivalent": "Methusael",
        "source_form": "Methusael",
        "greek_form": "Μαθουσάλα",
        "name_meaning": "who demands his death",
        "equivalent_source": "manual Cainite genealogy review",
        "equivalent_confidence": "manual",
        "footnote": "Standard English equivalent: Methusael. Source form: Methusael. Greek form: Μαθουσάλα. Name meaning: who demands his death. Equivalent source: manual Cainite genealogy review.",
    },
    {
        "name": "Tubal",
        "kind": "person",
        "first_reference": "Genesis 4:22",
        "source": "ot",
        "english_equivalent": "Tubal",
        "source_form": "Tubal",
        "greek_form": "Θόβελ",
        "name_meaning": "the earth; the world; confusion",
        "equivalent_source": "manual Greek-form review",
        "equivalent_confidence": "manual",
        "footnote": "Personal-name meaning: Tubal - the earth; the world; confusion. Source form: Tubal. Greek form: Θόβελ. Equivalent source: manual Greek-form review.",
    },
    {
        "name": "Achan",
        "kind": "person",
        "first_reference": "Joshua 7:1",
        "source": "ot",
        "english_equivalent": "Achan",
        "source_form": "Achar",
        "greek_form": "Αχαρ (Achar)",
        "name_meaning": "he that troubleth; troubler",
        "equivalent_source": "manual/familiar English equivalent",
        "equivalent_confidence": "manual",
        "footnote": "Greek form: Αχαρ (Achar). LXX uses Achar throughout; MT distinguishes Achan in Joshua from Achar in 1 Chronicles 2:7. Name meaning: he that troubleth; troubler.",
    },
    {
        "name": "Achan",
        "kind": "person",
        "first_reference": "Joshua 22:20",
        "source": "ot",
        "english_equivalent": "Achan",
        "source_form": "Achar",
        "greek_form": "Αχαρ (Achar)",
...
MANUAL_CONTEXTUAL_TRANSLITERATED_NOTE_SPECS = [
    ...
    ("Ieddouran", "2 Samuel 8:10", "ot", "Joram"),
...
EQUIVALENT_OVERRIDES = {
    ...
    "Abelbethmaachah": "Abel-beth-maachah",
    "Achaab": "Ahab",
    "Aoda": "Helah",
    "Arad": "Arad",
    "Aram": "Aram",
    "Ashkelonites": "Ashkelonites",
    "Ataroth-addar": "Ataroth-addar",
    "Akchō": "Acco",
    "Ambri": "Omri",
    "Anchous": "Achish",
    ...
    "Bethleem": "Bethlehem",
    "Bethlehem": "Bethlehem",
    "Chabasin": "Habazziniah",
    "Chebron": "Hebron",
    "Chezib": "Chezib",
    "Chinnereth": "Chinnereth",
    "Chinneroth": "Chinneroth",
    "Cinneroth": "Cinneroth",
    "Cozbi": "Cozbi",
    "Chiram": "Hiram",
    "Chōrēb": "Horeb",
    ...
    "Galgala": "Gilgal",
    "Gai-Benaiah-Hinnom": "Valley of Ben-Hinnom",
    "Galaaditis": "Gilead",
    "Gergesites": "Girgashites",
    "Gesam": "Geshem",
    "Gola": "Alvah",
    "Gedoliah": "Gedaliah",
    "Giezi": "Gehazi",
    ...
    "Sychem": "Shechem",
    "Symobor": "Shemeber",
    "Thabason": "Tahtim-hodshi",
    "Tahtim-hodshi": "Tahtim-hodshi",
    "Tahpanhes": "Tahpanhes",
    "Thaiman": "Teman",
    "Tanis": "Zoan",
    "Thebes": "Thebez",
    "Thamnasarach": "Timnath-serah",
    "Tholmi": "Talmai",
    "Thoada": "Naarah",
    "Thersa": "Tirzah",
    "Thaglathphellasar": "Tiglathpileser",
    "Thalgathphellasar": "Tiglathpileser",
...
EQUIVALENT_MEANING_OVERRIDES = {
    ...
    "Adah": "an assembly",
    "Ain": "eye; spring; fountain",
    "Ai": "heap; ruin",
    "Aiath": "heap; ruin",
    "Ahuzzath": "possession; holding",
    ...
    "Ashkelonites": "people of Ashkelon; weight; balance",
    "Baal-meon": "lord of dwelling; place of Baal",
    "Baalath-beer": "mistress of the well",
    "Baal-hanan": "Baal has been gracious; lord of grace",
    "Baal-peor": "master of the opening; lord of Peor",
    "Bela": "destruction; swallowing",
    "Birsha": "an evil; son who beholds",
    ...
    "Beth-nimrah": "house of clear water; house of the leopard",
    "Beth-shean": "house of rest",
    "Bethuel": "filiation of God",
    "Ben-hadad": "son of Hadad; son of noise",
    "Carmelite": "circumcised lamb; harvest; full of ears of corn",
    "Chezib": "lying; false",
    "Chinnereth": "harps; lyres",
    "Chinneroth": "harps; lyres",
    "Cinneroth": "harps; lyres",
    ...
    "Geshem": "rain; shower",
    "Girgashites": "dwellers on clayey soil; strangers drawing near",
    "Iron": "watchful; alert",
    "Juda": "the praise of the Lord; confession",
    "Judaea": "land of Judah",
    "Judas": "the praise of the Lord; confession",
    "Jezreel": "God sows",
    "Jezreelite": "belonging to Jezreel; God sows",
    "Jotbathah": "goodness; pleasantness",
    "Mishor": "level place; plain; plateau",
    "Melchishua": "king of help; my king saves",
    ...
    "Hauran": "cave-land; white region",
    "Hophra": "Pharaoh Hophra; Egyptian royal name",
    ...
    "Kerioth": "cities; towns",
    "Lamech": "powerful; overthrower",
    "Mahalaleel": "praise of God; shining one of God",
    "Maleleel": "praising God",
    "Maaziah": "consolation/strength of Yahweh",
    "Melzar": "master of wine; chief butler; steward",
    "Matthan": "gifts; rains",
    "Michael": "Who is like God?",
    "Ithra": "abundance; excellence",
    "Ithrite": "Jetherite; one who excels",
    ...
    "Sais": "Egyptian city-name form",
    "Saron": "his plain; his song",
    "Shealtiel": "asked or lent of God",
    "Shiphmite": "person of Shiphm; fruitful place/people-name form",
    "Shimea": "that hears, or obeys; perdition",
    "Siloam": "sent",
    "Sephina": "LXX place-name/direction form",
    "Shephelah": "lowland; plain",
    "Tahpanhes": "Egyptian fortress-city; Daphne",
    "Tahtim-hodshi": "lower/new land",
    "Tahtimhodshi": "lower/new land",
...
EQUIVALENT_OVERRIDES.update(
    {
        ...
        "Ramathaim-Zophim": "Ramathaim-Zophim",
        "Raōm": "Ir",
        "Selei": "Shilhi",
        "Sior": "Zair",
        "Sharon": "Sharon",
...
EQUIVALENT_MEANING_OVERRIDES.update(
    ...
    "Helper": "helper; advocate; comforter",
        ...
        "Stoics": "followers of the Stoa; porch-school philosophers",
        "Susa/Shushan": "lily",
        ...
        "Uzza/Uzzah": "strength",
        "Artemis": "Greek goddess name; associated with safe/whole",
        "Freedmen": "freed persons; formerly enslaved people",
        "Zealot": "zealous one",
        "Zealots": "zealous ones",
...
EQUIVALENT_MEANING_OVERRIDES.update(
    {
        ...
        "Kirjatharba": "city of four; fourth city",
        ...
        "Puhites": "people of Puvah; splendid branch",
    ...
    "Shumathites": "people of Shumah; desolation",
    "Shiphmites": "people of Shepham; bare/smooth place",
    "Shocho": "defense; bough",
    "Shuhite": "descendant or inhabitant of Shuah",
    "Shunammite": "person of Shunem; double resting place",
    "Siphmoth": "fruitful places",
    "Somer": "keeper; guard",
    "Tahpanhes": "Egyptian border city; traditional meaning linked with flight or temptation",
    "Tahapanes": "secret temptation",
        ...
        "Timnath-serah": "portion of abundance; Joshua's city",
        "Tophel": "ruin; folly; without understanding",
        "Topheth": "drum; place of burning/betrayal",
        "Vaizatha": "sprinkling the chamber",
        "Zattu": "olive tree; brightness",
        "Zareathites": "people of Zorah; leprosy/hornet-town",
        "Zeboiim": "deer; goats",
    ...
    "Potiphera": "belonging to the sun; priestly Egyptian name",
    "Purah": "branch; fruitful bough",
    "Sibbecai": "weaver; entangler",
...
EQUIVALENT_MEANING_OVERRIDES.update(
    {
        ...
        "Agagite": "descendant or follower of Agag; flame/violent one",
        "Ahava": "water; essence; generation",
        "Ajah": "hawk; vulture",
        "Aloes": "aloes; fragrant spice",
        "Alvan": "tall; high",
        "Aphphousoth": "separated; exposed place",
        "Apharsachites": "officials or people beyond the River; Persian administrative group",
        "Achshaph": "fascination; sorcery",
        "Anamim": "answers; afflictions",
        "Aridai": "lion-like",
        "Aridatha": "lion-like decree",
        "Arisai": "lion-like",
        "Arodi": "wild ass; roving one",
        "Aros": "flea; moth-fruit name-family",
        "Asuppim": "collections; storehouses",
        "Ashkelon": "weight; balance",
        "Ben-Hur": "son of Hur; son of whiteness/nobility",
        "Aspatha": "horse-given",
        "Azzur": "helper; one helped",
        "Azarel": "help of God",
        "Azel": "noble; reserved",
        ...
        "Barkos": "son of Kos; painter-colored one",
        "Bazlith": "stripped; spoiled",
        "Bazluth": "stripped; spoiled",
        "Beeri": "my well",
        "Beten": "belly; hollow",
        "Chusi": "Cushite; blackness",
        "Casiphia": "silver; money-place",
        "Caphtorim": "people of Caphtor; crown/island people",
        "Diklah": "palm grove",
        "Dumah": "silence",
        ...
        "Elpelet": "God is deliverance",
        "Emer": "sheaf; handful",
        "Emims": "terrors; dreadful ones",
        "Ephod": "priestly garment; covering",
        "Ephai": "gloomy; dark",
        "Erael": "watcher of God",
        "Erech": "length; health",
        "Eri": "watchful; city name-family",
        "Eshton": "rest; quiet",
        "Eth-kazin": "time/place of a prince",
        "Ezbon": "hasty understanding; splendor",
        "Gether": "fear; valley of trial",
        "Gaham": "burning; blackness",
        "Gedaliah": "Yahweh is great; Yahweh has magnified",
        ...
        "Hariph": "autumn rain; harvest-time",
        "Habaziniah": "lamp of Yahweh; Yahweh hides",
        "Hadoram": "Hadad is exalted; noble honor",
        "Hassenaah": "thorny; hated",
        "Hazar-enan": "village of springs",
        "Hazarmaveth": "village of death",
        "Hemdan": "pleasant; desirable",
        "Haziel": "God sees; vision of God",
        "Hauran": "cave-land; white region",
        "Hali": "necklace; ornament",
        "Helkath": "portion; smoothness",
        "Hul": "circle; pain; sand",
        ...
        "Jahzerah": "Yahweh returns; Yahweh helps",
        "Jotbah": "goodness",
        "Jerah": "moon; month",
        ...
        "Kir-heres": "city of the sun; city of potsherds",
        "Lehabim": "flames; flaming ones",
        "Letushim": "hammered; oppressed",
        "Leummim": "peoples; nations",
        "Ludim": "descendants of Lud; strife",
        "Maachathite": "person of Maachah; oppression/squeezing",
        "Mahalath": "sickness; song-tune name",
        "Magaphes": "body/slaughter name-family",
        "Mash": "drawn out; burden",
        "Makaz": "end; boundary",
        "Marah": "bitter",
        "Masemanne": "fatness; strength",
        "Massalem": "peaceable; perfect",
        "Matred": "pushing forward; expulsion",
        "Mattanah": "gift",
        "Meera": "bitter; disputing one",
        "Mehetabel": "God benefits; God makes good",
        "Meshillemoth": "peaceable; repayment",
        "Meshullemeth": "repaid; devoted; peaceable",
        "Meshullam": "friend; repaid; devoted",
        "Mesozebel": "Jezebel-name family; chaste/where is the prince",
        "Meunites": "dwellers; habitation people",
        "Meribah": "strife; contention",
        "Mene": "numbered",
        "Mibzar": "fortress; stronghold",
        "Mispereth": "numbering; scribe",
        "Mizpar": "number; writing",
        "Moabitans": "Moabites; from Moab, of his father",
        "Mount Seir": "mountain of Seir; hairy/rough",
        "Myrsinon": "myrtle place",
        "Naamathite": "person of Naamah; pleasantness",
        "Naamathites": "people of Naamah; pleasantness",
        "Naphtuhim": "openings; opened ones",
        "Netophah": "drop; distillation",
        "Nohah": "rest; quiet",
        "Obal": "bare; stripped",
        "Osee": "salvation",
        "Ophir": "fruitful region; abundance",
        "Ozriel": "God is my help/strength",
        "Oziel": "strength of God",
        "Parosom": "flea; moth-fruit name-family",
        "Pathros": "southern land; region of upper Egypt",
        "Pathrusim": "people of Pathros; southern Egyptians",
        "Peres": "divided; broken",
        "Pheliel": "God is wonderful; face/vision of God",
        "Piltai": "Yahweh delivers; my escape",
        "Raasson": "prince; delight",
        "Rezin": "good will; firm one",
        "Rephah": "healing; comfort",
        "Resen": "bridle; restraint",
        "Remmon": "pomegranate; elevation",
        "Resheph": "flame; burning coal",
        "Roollam": "elevation; rolling",
        "Sarbacha": "royal official name",
        "Selo": "rock; strong place",
        "Selles": "prince; leader",
        "Segor": "little; small",
        "Senuah": "bristling; hated",
        "Shaaph": "division; branch",
        "Shechaniah": "Yahweh dwells; Yahweh has taken up residence",
        "Sheleph": "drawn out; sheath",
        "Shaveh": "plain; level place",
        "Shiphtan": "judgment; judicial",
        "Shuah": "wealth; cry for help",
        "Shuham": "pit; depression; humbling",
        "Shuhamite": "person of Shuham; pit/depression clan",
        "Shimron": "watch; guard",
        ...
        "Tekel": "weighed",
        "Tabbaoth": "rings; seals",
        "Talmon": "oppressor; violent one",
        "Tamar": "palm tree",
        ...
        "Tirshatha": "governor; feared official",
        "Tolad": "a generation",
        "Tou": "living; declaring",
        "Uzal": "going away; wandering",
        "Valley of Rephaim": "valley of the Rephaim; giants/relaxed ones",
        "Zaccai": "pure; clean",
        "Zabdiel": "gift/endowment of God",
        "Zaphnathpaaneah": "Egyptian name of Joseph; revealer/preserver of life",
        "Zarhites": "descendants of Zerah; rising/light",
        "Zechora": "remembered; male name-family",
        "Zetham": "olive; their olive",
...
def main() -> None:
    ...
    parser.add_argument(
        "--summary-only",
        action="store_true",
        help="Print compact diagnostics while still writing full output files.",
    )
    ...
    for _, data in sorted(tokens.items(), key=lambda item: (int(item[1]["first_order"]), item[0])):
        ...
        if token in BAD_AUTOGENERATED_NOTE_NAMES:
            counts["skipped_bad_autogenerated_note_name"] += 1
            continue
            ...
            json.dumps(
                {
                    ...
                    "coverage_csv": diagnostics["coverage_csv"],
                    "coverage_md": diagnostics["coverage_md"],
                    "note_rows": diagnostics["note_rows"],
