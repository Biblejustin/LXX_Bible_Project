...
def add_title_page(
    ...
    *,
    ...
    lines = [
        ...
        f"Footnote numbering restarts by {footnote_number_restart}.",
    ]
    if logos:
...
- Footnote numbering: one DOCX file with internal Word section metadata set to restart visible footnote numbering by `{footnote_number_restart}`.
