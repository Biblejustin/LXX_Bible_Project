...
VERSE_SECTIONS: list[tuple[str, list[VerseItem | TextItem]]] = [
    ...
    ("Peace and Hope", [VerseItem("Jeremiah 29:11"), VerseItem("Romans 15:13"), VerseItem("Philippians 4:6-7"), VerseItem("John 16:33"), VerseItem("Psalm 34:18"), VerseItem("Isaiah 26:3-4"), VerseItem("Romans 5:1")]),
    ...
    ("Repentance and Forgiveness", [VerseItem("1 John 1:9"), VerseItem("Acts 3:19"), VerseItem("Psalm 51:10"), VerseItem("2 Chronicles 7:13-14"), VerseItem("Romans 6:23"), VerseItem("Luke 15:7"), VerseItem("Matthew 6:14-15")]),
