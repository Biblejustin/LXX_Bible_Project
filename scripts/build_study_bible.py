...
RAW = ROOT / "data" / "raw"
OUTPUT = ROOT / "output"
OUTPUT_PREFIX_CROSSREFS_ONLY = "LXX2012_UKJV_study_bible_crossrefs_only"
OUTPUT_PREFIX_CROSSREFS_NORMAL = "LXX2012_UKJV_study_bible_crossrefs_normal"
...
def main() -> None:
    ...
    if args.output_prefix == "LXX2012_UKJV_study_bible_prototype":
        if args.crossrefs_only and args.normal_crossrefs:
            args.output_prefix = OUTPUT_PREFIX_CROSSREFS_NORMAL
        elif args.crossrefs_only:
            args.output_prefix = OUTPUT_PREFIX_CROSSREFS_ONLY
