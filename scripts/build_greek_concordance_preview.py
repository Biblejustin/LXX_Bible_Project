...
BROAD_TERMS: tuple[Term, ...] = (
    ...
    broad_term("faithfulness", "Faithfulness", "πιστότης", "pistotes", "πιστο", "faithfulness;faithful"),
    broad_term("justice", "Justice / Judgment", "κρίμα", "krima", "κριμα;κρισε", "justice;judgment"),
    broad_term("ordinance", "Ordinance / Statute", "δικαίωμα", "dikaioma", "δικαιωμ", "ordinance;statute;requirement"),
    broad_term("instruction", "Instruction / Discipline", "παιδεία", "paideia", "παιδει", "instruction;discipline;correction"),
    broad_term("prudence", "Prudence", "φρόνησις", "phronesis", "φρονη;φρονιμ", "prudence;understanding;wise"),
    broad_term("know-verb", "Know", "γινώσκω", "ginosko", "γινωσκ;εγνω", "know;knew;known"),
    broad_term("have-mercy", "Have Mercy", "ἐλεέω", "eleeo", "ελεε;ελεησ", "have mercy;show mercy"),
    broad_term("forgive-verb", "Forgive", "ἀφίημι", "aphiemi", "αφι;αφεθ;αφεσ", "forgive;leave;release"),
    broad_term("sanctify-verb", "Sanctify / Make Holy", "ἁγιάζω", "hagiazō", "αγιαζ;ηγιασ", "sanctify;make holy;hallow"),
    broad_term("perfect-complete", "Perfect / Complete", "τέλειος", "teleios", "τελει", "perfect;complete;blameless"),
    broad_term("upright", "Upright", "εὐθύς", "euthys", "ευθυ", "upright;straight"),
    broad_term("exalt", "Exalt / Lift Up", "ὑψόω", "hypsoo", "υψο;υψω", "exalt;lift up;high"),
    broad_term("glorify", "Glorify", "δοξάζω", "doxazo", "δοξαζ", "glorify;honor"),
    broad_term("rebuke", "Rebuke", "ἐπιτιμάω", "epitimao", "επιτιμ", "rebuke;charge"),
    broad_term("rest", "Rest", "ἀνάπαυσις", "anapausis", "αναπαυ;καταπαυ", "rest"),
    broad_term("yoke", "Yoke", "ζυγός", "zygos", "ζυγ", "yoke"),
    broad_term("burden", "Burden / Load", "φορτίον", "phortion", "φορτι;βαρο;φορτ", "burden;load"),
    broad_term("armor", "Armor / Weapon", "πανοπλία", "panoplia", "πανοπλ;οπλ", "armor;weapon"),
    broad_term("helmet", "Helmet", "περικεφαλαία", "perikephalaia", "περικεφαλ", "helmet"),
    broad_term("breastplate", "Breastplate", "θώραξ", "thorax", "θωρακ", "breastplate"),
    broad_term("shoes", "Shoes / Sandals", "ὑπόδημα", "hypodema", "υποδημ;σανδαλ", "shoe;shoes;sandal"),
    broad_term("arrow", "Arrow", "βέλος", "belos", "βελ;τοξευμ", "arrow"),
    broad_term("lion", "Lion", "λέων", "leon", "λεον", "lion"),
    broad_term("wolf", "Wolf", "λύκος", "lykos", "λυκ", "wolf"),
    broad_term("bear-animal", "Bear", "ἄρκτος", "arktos", "αρκτ", "bear"),
    broad_term("goat", "Goat", "τράγος", "tragos", "τραγ;εριφ", "goat;kid"),
    broad_term("ox-bull", "Ox / Bull", "βοῦς", "bous", "βου;βοο;μοσχ", "ox;bull;calf"),
    broad_term("donkey", "Donkey", "ὄνος", "onos", "", "donkey;ass;colt", forms="ονοσ;ονου;ονον;ονω;ονοι;ονουσ;ονων"),
    broad_term("camel", "Camel", "κάμηλος", "kamelos", "καμηλ", "camel"),
    broad_term("dove", "Dove", "περιστερά", "peristera", "περιστερ", "dove"),
    broad_term("raven", "Raven", "κόραξ", "korax", "κορακ", "raven"),
    broad_term("worm", "Worm", "σκώληξ", "skolex", "σκωληκ", "worm"),
    broad_term("flock", "Flock", "ποίμνη", "poimne", "ποιμν", "flock"),
    broad_term("valley", "Valley", "φάραγξ", "pharanx", "φαραγγ;κοιλαδ", "valley"),
    broad_term("plain", "Plain", "πεδίον", "pedion", "πεδι", "plain;field"),
    broad_term("island", "Island / Isle", "νῆσος", "nesos", "νησ", "island;isle"),
    broad_term("north", "North", "βορρᾶς", "borras", "βορρ;βορε", "north"),
    broad_term("south", "South", "νότος", "notos", "νοτ;λιψ", "south"),
    broad_term("east", "East / Rising", "ἀνατολή", "anatole", "ανατολ", "east;rising;branch"),
    broad_term("west", "West", "δύσις", "dysis", "δυσμ", "west"),
    broad_term("dust", "Dust", "χοῦς", "chous", "χουν;κονιορτ", "dust"),
    broad_term("ashes", "Ashes", "σποδός", "spodos", "σποδ", "ashes"),
    broad_term("clay", "Clay", "πηλός", "pelos", "πηλ", "clay"),
    broad_term("brick", "Brick", "πλίνθος", "plinthos", "πλινθ", "brick"),
    broad_term("wall", "Wall", "τεῖχος", "teichos", "τειχ", "wall;walls"),
    broad_term("foundation", "Foundation", "θεμέλιος", "themelios", "θεμελι", "foundation"),
    broad_term("cornerstone", "Cornerstone / Corner", "ἀκρογωνιαῖος", "akrogoniaios", "ακρογωνι;γωνια", "cornerstone;corner"),
    broad_term("key", "Key", "κλείς", "kleis", "κλειδ", "key"),
    broad_term("table", "Table", "τράπεζα", "trapeza", "τραπεζ", "table"),
    broad_term("threshing-floor", "Threshing Floor", "ἅλων", "halon", "αλων", "threshing floor"),
    broad_term("millstone", "Millstone / Mill", "μύλος", "mylos", "μυλ", "millstone;mill"),
    broad_term("net", "Net / Snare", "δίκτυον", "diktyon", "δικτυ;σαγηνη;παγιδ", "net;snare;trap"),
    broad_term("ship", "Ship / Boat", "πλοῖον", "ploion", "πλοι", "ship;boat"),
    broad_term("purple", "Purple", "πορφύρα", "porphyra", "πορφυρ", "purple"),
    broad_term("linen", "Linen", "βύσσος", "byssos", "βυσσ;σινδον", "linen"),
    broad_term("scarlet", "Scarlet", "κόκκινος", "kokkinos", "κοκκιν", "scarlet"),
    broad_term("white", "White", "λευκός", "leukos", "λευκ", "white"),
    broad_term("black", "Black", "μέλας", "melas", "μελαν", "black"),
    broad_term("red", "Red", "πυρρός", "pyrros", "πυρρ;ερυθρ", "red"),
    broad_term("small-little", "Small / Little", "μικρός", "mikros", "μικρ", "small;little"),
    broad_term("great-large", "Great / Large", "μέγας", "megas", "μεγ;μεγαλ", "great;large"),
    broad_term("few", "Few", "ὀλίγος", "oligos", "ολιγ", "few;little"),
    broad_term("many", "Many / Much", "πολύς", "polys", "πολλ", "many;much"),
    broad_term("first", "First", "πρῶτος", "protos", "πρωτ", "first"),
    broad_term("last", "Last", "ἔσχατος", "eschatos", "εσχατ", "last"),
    broad_term("amen", "Amen", "ἀμήν", "amen", "αμην", "amen"),
    broad_term("hosanna", "Hosanna", "ὡσαννά", "hosanna", "ωσανν", "hosanna"),
    broad_term("woe", "Woe", "οὐαί", "ouai", "ουαι", "woe"),
